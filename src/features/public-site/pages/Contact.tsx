  ...
  return (
    <PublicLayout>
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-red-700 via-red-600 to-red-500 text-white">
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-6 py-24 lg:py-32">
          ...
          >
            ...
            <p className="text-red-50 text-lg md:text-xl max-w-2xl mx-auto leading-relaxed">
      ...
      <section className="py-24 bg-gray-50 relative overflow-hidden">
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-red-50/30 via-transparent to-transparent"></div>
        <div className="relative z-10 max-w-5xl mx-auto px-6">
          ...
          >
            ...
            >
              <div className="absolute top-0 right-0 w-32 h-32 bg-gradient-to-br from-red-50 to-red-100 opacity-0 group-hover:opacity-100 transition-opacity duration-500 rounded-full -translate-y-16 translate-x-16"></div>
              <div className="relative p-6 flex items-start gap-4">
                <div className="w-14 h-14 bg-gradient-to-br from-red-100 to-red-200 rounded-xl flex items-center justify-center shadow-md group-hover:scale-110 transition-transform duration-300">
            ...
            >
              ...
              <div className="relative p-6 flex items-start gap-4">
                <div className="w-14 h-14 bg-gradient-to-br from-red-100 to-red-200 rounded-xl flex items-center justify-center shadow-md group-hover:scale-110 transition-transform duration-300">
                  <FaTelegramPlane className="w-7 h-7 text-red-600" />
                </div>
                <div className="flex-1">
            ...
            >
              ...
              <div className="relative p-6 flex items-start gap-4">
                <div className="w-14 h-14 bg-gradient-to-br from-red-100 to-red-200 rounded-xl flex items-center justify-center shadow-md group-hover:scale-110 transition-transform duration-300">
                  <FaFacebookF className="w-7 h-7 text-red-600" />
                </div>
                <div className="flex-1">
                  <h3 className="font-bold text-xl text-gray-900 mb-2">
                    Facebook
            ...
            <motion.div
              variants={fadeInUp}
              whileHover={{ y: -8 }}
              className="md:col-span-2 group relative bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 overflow-hidden"
            >
              <div className="absolute top-0 right-0 w-64 h-64 bg-gradient-to-br from-red-50 to-red-100 opacity-0 group-hover:opacity-100 transition-opacity duration-500 rounded-full -translate-y-32 translate-x-32"></div>
              <div className="relative p-6 flex items-start gap-4">
                <div className="w-14 h-14 bg-gradient-to-br from-red-100 to-red-200 rounded-xl flex items-center justify-center shadow-md group-hover:scale-110 transition-transform duration-300">
              ...
              <div className="space-y-3">
                <div className="flex items-center gap-3 py-2">
                  ...
                  <span className="text-gray-700">
                    Email responses within <strong className="text-gray-900">24 hours</strong>
                  </span>
                </div>
                <div className="flex items-center gap-3 py-2">
                  <CheckBadgeIcon className="w-5 h-5 text-green-500" />
                  <span className="text-gray-700">
                    Phone support available during <strong className="text-gray-900">business hours</strong>
                  </span>
                </div>
                <div className="flex items-center gap-3 py-2">
                  <CheckBadgeIcon className="w-5 h-5 text-green-500" />
                  <span className="text-gray-700">
                    Telegram messages typically answered within <strong className="text-gray-900">1-2 hours</strong>
                  </span>
                </div>
              </div>
            </motion.div>
          ...
          >
            {[
              ...
              <motion.a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className={`flex items-center gap-3 px-6 py-3 bg-gray-50 rounded-xl shadow-md hover:shadow-xl transition-all duration-300 ${social.color} hover:text-white group`}
              >
      ...
      <section className="bg-gray-900 py-20">
        <div className="max-w-4xl mx-auto px-6">
          <motion.div
            ...
            viewport={{ once: true }}
            className="relative bg-gradient-to-br from-red-700 to-red-600 rounded-3xl overflow-hidden shadow-2xl"
          >
            ...
            <div className="relative z-10 p-12 md:p-16 text-center">
              ...
              <motion.div variants={scaleOnHover} initial="rest" whileHover="hover">
                <a
                  href="tel:+251110000000"
                  className="inline-flex items-center gap-2 bg-white text-red-600 px-8 py-3 rounded-xl font-bold hover:bg-gray-100 transition-all shadow-lg"
                >
                  Call Support Now
