    ...
    <PublicLayout>
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-red-700 via-red-600 to-red-500 text-white">
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-6 py-24 lg:py-32">
          ...
          >
            ...
            <p className="text-red-50 text-lg md:text-xl max-w-3xl mx-auto leading-relaxed">
        ...
        >
          <span className="text-sm text-white/60">Discover more</span>
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-6">
          ...
          >
            ...
            <div className="space-y-6 text-gray-700">
              ...
              <p className="leading-relaxed text-lg text-gray-600 border-l-4 border-red-500 pl-4">
          ...
          >
            {[
              ...
              >
                ...
                <div className="mt-4 flex items-center gap-2 text-red-600 opacity-0 group-hover:opacity-100 transition-opacity">
      ...
      <section className="py-24 bg-gray-50 relative overflow-hidden">
        <div className="absolute inset-0">
          <div className="absolute top-0 left-0 w-96 h-96 bg-red-100 rounded-full filter blur-3xl opacity-30"></div>
          <div className="absolute bottom-0 right-0 w-96 h-96 bg-red-100 rounded-full filter blur-3xl opacity-30"></div>
        </div>
          ...
          >
            ...
            <div className="relative z-10 p-12 md:p-16 text-center">
              ...
              <motion.div variants={scaleOnHover} initial="rest" whileHover="hover">
                <Link
                  to="/login"
                  className="inline-flex items-center gap-2 bg-red-600 text-white px-8 py-3 rounded-xl font-bold hover:bg-red-700 transition-all shadow-lg"
                >
                  Get Started
